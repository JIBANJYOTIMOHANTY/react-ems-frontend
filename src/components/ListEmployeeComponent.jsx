    ...
    return (
        <div className='w-full h-screen bg-gray-700'>
            ...
            <div className='relative overflow-x-auto shadow-md sm:rounded-lg'>
                <h2 className='mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-4xl '>List of Employees : </h2>
                <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-[1.3rem] px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 ml-1" onClick={addEmployee}>Add Employee</button>
                ...
                <table className='w-full cursor-pointer text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400'>
                    <thead className='text-xs border border-black text-black uppercase bg-gray-50 dark:bg-gray-700 '>
                        <tr>
                            ...
                            <th className='px-6 py-3'>Employee First Name</th>
                            <th className='px-6 py-3'>Employee Last Name</th>
                            <th className='px-6 py-3'>Employee Email Id</th>
